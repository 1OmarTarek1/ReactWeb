...
const Details = () => {
    ...
    return(
    <>
        <SectionHeader><span className='title-cent'>FORTNITE DETAILS</span></SectionHeader>
        <SectionWrapper>
            ...
            <div className='three-imgs'>
                <div className='img-div'><img src={details_01}  alt=''/></div>
                <div className='img-div'><img src={details_02} alt=''/></div>
                <div className='img-div'><img src={details_03} alt=''/></div>
            </div>
        ...
        <span className='c-btn'><SecondaryButton>Download Fortnite !</SecondaryButton></span> 
       </SectionWrapper>
    </>
