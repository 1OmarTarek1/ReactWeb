...
const Details = () => {
    ...
    return(
    <>
        <SectionHeader><span className='title-cent'>COD DETAILS</span></SectionHeader>
        <SectionWrapper>
            ...
            <div className='three-imgs'>
                <div className='img-div'><img src={callOfDuty_01} alt=''/></div>
                <div className='img-div'><img src={callOfDuty_02} alt=''/></div>
                <div className='img-div'><img src={callOfDuty_03} alt=''/></div>
            </div>
        ...
        <span className='c-btn'><SecondaryButton>Download COD !</SecondaryButton></span> 
       </SectionWrapper>
    </>
