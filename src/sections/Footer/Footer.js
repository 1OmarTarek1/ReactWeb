            ...
            <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-6 col-lg-4">
                            <div className="info">
                            <NavLink to="/" className="navbar-brand logo mb-4"><img src={logo} alt=''></img></NavLink>
                                <p className="mb-5">
                                ...
                                <div className="copyright mb-5">
                                    ...
                                    <div>
                                        &copy; 2023 - <span className='fw-bold'>CYBORG</span>
                                    </div>
                        ...
                        <div className="col-md-6 col-lg-4">
                            <div className="contact mb-5">
                                ...
                                <PrimaryButton>OmarTarek@gmail.com</PrimaryButton>
